...
namespace Toy2
{
	...
	namespace ConstructionYard
	{
		...
		int16_t g_liftPairMotionScript[] = { 1, 0, 0, 0x316, 0xC, 3, 0xFF, 0x20, 1, 0, 0, 0, 0xC, 3, 0xFF, 0x20, 0, 0x10 };
		// GLOBAL: TOY2 0x004F1C64
		int16_t g_platformPairMotionScript[] = { 1, 0, 0, 0x316, 0xC, 3, 0x7F, 0x20, 1, 0, 0, 0, 0xC, 3, 0x7F, 0x20, 0, 0x10 };
