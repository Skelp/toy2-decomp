...
- [ ] 3. Add normalized context and evidence packs. Each pack can retrieve the accepted source that has matching provenance.
- [ ] 4. Add a post-write impact and refuter check. Source promotion requires an accepted claim that survives this check.
- [ ] 5. Add an allowlisted leaf differential oracle. Each oracle result has a receipt that binds all inputs and outputs.
